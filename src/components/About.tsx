      ...
      <div className="max-w-[1440px] mx-auto px-6 md:px-12 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8 items-stretch">
          ...
          <FadeUp delay={0.2} className="h-full">
            <div className="h-full bg-[#180914]/80 backdrop-blur-md border border-[#ff4d29]/20 hover:border-[#ff4d29]/40 rounded-2xl md:rounded-3xl p-6 sm:p-8 md:p-10 flex flex-col justify-between transition-all duration-300 hover:-translate-y-1 shadow-xl">
