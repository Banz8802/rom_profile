        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 md:gap-6">
          {WHAT_I_DO_CARDS.map((card, index) => (
            <FadeUp key={card.number} delay={0.15 * (index + 1)} className="h-full">
              <div className="h-full bg-[#180914]/80 backdrop-blur-md border border-[#ff4d29]/20 hover:border-[#ff4d29]/50 rounded-2xl md:rounded-3xl p-6 sm:p-7 md:p-8 flex flex-col justify-between transition-all duration-300 hover:-translate-y-1.5 shadow-xl hover:shadow-[#ff4d29]/10 group">
                <div>
                  {/* Number Accent */}
